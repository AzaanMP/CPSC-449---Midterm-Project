...
public class AttendeeController {
    ...
    // Register a new attendee (Returns a Map to hide the JPA Entity)
    @PostMapping
    public ResponseEntity<Map<String, Object>> createAttendee(@RequestBody Attendee attendee) {
    ...
    // Get all bookings for an attendee (Delegates logic to the Service)
